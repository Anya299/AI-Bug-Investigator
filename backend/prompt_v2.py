...
def build_user_message(
    ...
    mode) now actually reaches the model -- previously only description,
    language, severity, and stack_trace were used, so the "full" form and
    "quick" form produced an identical prompt regardless of what the user
    filled in.
    """
